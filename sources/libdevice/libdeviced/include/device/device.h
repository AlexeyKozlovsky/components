...
class Device {
 ...
 public:
  ...
  VARIANT__D readProperty(const std::string &property_name, ErrorCode *error_code = nullptr);
  VARIANT__D writeProperty(const std::string &property_name, const VARIANT__D &value, ErrorCode *error_code = nullptr);
  VARIANT__D executeCommand(const std::string &command_name, const VARIANT__D &argin, ErrorCode *error_code = nullptr);
