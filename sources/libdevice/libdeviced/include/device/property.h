...
class Property: public DeviceAttribute {
 public:
   ...
   */
  VARIANT__D getValue(ErrorCode *error_code = nullptr);
   ...
   */
  VARIANT__D readValue(ErrorCode *error_code = nullptr);
   ...
   * @param error_code код ошибки, при работе данного метода
   */
  void writeValue(const VARIANT__D &value, ErrorCode *error_code = nullptr);
 ...
 protected:
   ...
   * @return прочитанное значение свойства
   */
  virtual VARIANT__D read(ErrorCode *error_code = nullptr) = 0;
   ...
   * @param error_code код ошибки, при работе данного метода
   */
  virtual void write(const VARIANT__D &value, ErrorCode *error_code = nullptr) = 0;
