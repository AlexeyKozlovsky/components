...
#
#   1. if WIDGETS_SHARED_LIBS is defined and:
...
if(NOT TARGET widgets::widgets)
    ...
    if(DEFINED WIDGETS_SHARED_LIBS)
        if(WIDGETS_SHARED_LIBS)
            set(type "shared")
        else()
            set(type "static")
        endif()
    elseif(BUILD_SHARED_LIBS AND EXISTS "widgets-shared-targets.cmake")
        set(type "shared")
    elseif(EXISTS "widgets-static-targets.cmake")
        set(type "static")
    else()
        set(type "shared")
    endif()
